...
// #define CODE_211 "212 create_channel\n"
// #define CODE_211 "213 create_thread\n"
// #define CODE_211 "214 create_reply\n"
...
(id INTEGER PRIMARY KEY, uuid TEXT, channel TEXT, user TEXT, title TEXT, body TEXT, timestamp TEXT);"
